...
class IterativeSearchTests(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual(recursive.binary_search(numbers, 4), True)

    def test_2(self):
        """should return True when the target is 10"""
        self.assertEqual(recursive.binary_search(numbers, 10), True)

    def test_3(self):
        """should return False when the target is 0"""
        self.assertEqual(recursive.binary_search(numbers, 0), False)

    def test_4(self):
        """should return False when the target is 12"""
        self.assertEqual(recursive.binary_search(numbers, 12), False)
